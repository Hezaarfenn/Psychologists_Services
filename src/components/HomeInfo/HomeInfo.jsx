    ...
    <section className="flex flex-col gap-10 w-full max-w-[595px] mt-10 md:mt-[222px] mb-10 md:mb-[140px] px-4">
      ...
      <div className="">
        <Link to="/psychologists">
          <button className="relative bg-[#54BE96] hover:bg-[#36A379] cursor-pointer rounded-full text-[#FBFBFB] text-base md:text-xl font-medium py-3 px-8 md:py-3.5 md:px-[50px] flex items-center gap-2">
            Get started
